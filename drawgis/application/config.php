...
$dr->config['menus'] = array(
  ...
  'my-navbar' => array(
    'index'	=> array('label'=>'Startsida', 'url'=>'my/home'),
    'home'      => array('label'=>'Om', 'url'=>'my'),
    'blog'      => array('label'=>'Nyheter', 'url'=>'my/news'),
    'guestbook' => array('label'=>'Gästbok', 'url'=>'my/guestbook'),
    'pictures'	=> array('label'=>'Bilder', 'url'=>'my/pictures'),
    'aboutMe'	=> array('label'=>'Om mig', 'url'=>'my/me'),
    'forum'	=> array('label'=>'Forum', 'url'=>'my/forum'),
...
$dr->config['theme'] = array(
  ...
  'data' => array (
  	'header' => '<h1>Emil Jensen</h1>',
	'footer' => '<p>Ett arbete av Sanna Widell</h1>',
	'slogan' => 'En sida om Emil Jensen',
