...
class CDrawgis implements ISingelton {
	...
	protected function __construct() 
	{
		...
		$this->xml = simplexml_load_file("http://www.emiljensen.se/h09/feed/");
	...
	public function themeEngineRender()
	{
		...
		$themeImgUrl  = $this->request->base_url . $this->config['theme']['imgUrl'];
	...
	public function drawMenu($menu) {
		...
		if(isset($this->config['menus'][$menu])) 
		{
			...
			{
				if ( $val['url'] == "my/forum"  && !$this->isAuthent() )
				{
