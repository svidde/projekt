...
class CMGuestbook extends CObject implements IHasSQL, IModule  {
	...
	public static function SQL($key=null) {
		...
		'delete from guestbook by id'   => 'DELETE FROM Guestbook WHERE id=?;',
		);
  ...
  {
  	  $this->db->executeQuery(self::SQL('delete from guestbook by id'), array($id));
  	  $this->session->addMessage('info', "Removed messages from the database table where id: $id");
  }
